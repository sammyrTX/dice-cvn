"""Process game play - Web App Version"""
...
def web_player_turn(scorepad):
    ...
    while True:
        ...
        # from user to use in next roll. HTML will handle quitting game or
        # keeping all dice and moving to scoring
